---
title: "Chronic Stress Mice"
subtitle: "Taylen Arvay / Cognitive Disorders Research Lab"
...
params:
  ...
  signal_file: "kinome_data/_KRSAsOutput_Median_SigmBg_231024100231.txt" # Change the file name to the one you have
  saturation_file: "kinome_data/_KRSAsOutput_Signal_Saturation_231024100232.txt" # Change the file name to the one you have
...
comparisons <- list(
  COMP1 = c(groups[2], groups[1]),
  COMP2 = c(groups[3], groups[1]),
  COMP3 = c(groups[4], groups[1]),
  COMP4 = c(groups[4], groups[3])
)
```
